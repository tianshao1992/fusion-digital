...
const modules: TwinModule[] = [
  ...
  { id: 'data', no: '08', cn: '数据基座', en: 'DATA FOUNDATION', summary: '配置、时间、坐标、单位、血缘和不确定度。', input: '全域原始数据、配置、模型与实验记录', output: '对时、版本化、可发现、可追溯的数据产品', aiRole: '语义映射与数据质量辅助；不得改写原始证据。', trust: '主数据、访问控制、校验和、版本与来源账本。', href: '/data-foundation', color: '#65e6d2', position: [425, 315], size: [176, 92], intensities: [3, 4, 4, 4, 4, 4] },
