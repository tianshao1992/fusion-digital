  ...
  return (
    <div className="diagnosticsCatalog">
      ...
      <section className="diagnosticsDeviceExplorer" id="devices">
        <div className="diagnosticsSectionHead"><p className="diagnosticsIndex">DEVICE VIEW</p><h2>{en?'Facility diagnostic profiles':'装置诊断档案'}</h2><p>{en?'Open profiles for papers and software. They do not imply that all systems were available together in every campaign.':'展开查看论文、数据平台与软件。档案不代表各系统在所有实验周期同时可用。'}</p></div>
