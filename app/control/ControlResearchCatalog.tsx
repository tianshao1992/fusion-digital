...
export default function ControlResearchCatalog() {
  ...
  return <>
    ...
    <section className="controlDeviceExplorer" id="devices">
      <div className="controlSectionHead"><p className="controlIndex">DEVICE / PCS VIEW</p><h2>装置与 PCS 档案</h2><p>查看 PCS 架构、周期、任务、传感器、执行器、论文、代码与迁移缺口。使用装置数据不等于已在该装置部署。</p></div>
