  ...
  return (
    <main className="diagnosticsPage">
      ...
      <section className="diagnosticsThesis">
        ...
        <h2><span>从观测估计装置状态，</span>说明可信度、误差、模型偏差与安全决策范围。</h2>
        <div>
          <p>真实诊断提供有噪声和选择效应的局部观测，集成反演估计状态与不确定度，合成诊断将模型投影到仪器空间。校准须在同一配置下比较两条路径。</p>
          <p>电厂诊断还需覆盖磁体、结构、真空、低温、燃料/氚、冷却与能量转换，联通等离子体状态和工程健康。</p>
        </div>
      </section>
      ...
      <section className="diagnosticsLoop" id="closed-loop">
        <div className="diagnosticsSectionHead">
          ...
          <h2>真实与合成诊断的双向测量链</h2>
          <p>点击节点查看职责。实时决策只用通过质量门的冻结产品；保留原始信号、标定与处理版本，以便回放、归因和再验证。</p>
        </div>
      ...
      <section className="diagnosticsTaxonomy" id="taxonomy">
        <div className="diagnosticsSectionHead">
          ...
          <h2>系统工程与计量底座 · 十一类任务</h2>
          <p>DG0 跨域支撑，DG1–DG8 按被测对象分类，DG9–DG11 负责前向模型、联合反演与决策接口。每条记录仅计一个主任务，可关联多项任务。</p>
        </div>
      ...
      <section className="diagnosticsEvidence" id="evidence">
        <div className="diagnosticsSectionHead">
          ...
          <h2>科学证据 E · 工程部署 D</h2>
          <p>E4 表示装置在线、实时或常规使用，不等于 D5 安全资格。D5 另需审批、配置责任、测试、变更与生命周期证据。</p>
        </div>
