...
const modules: TwinModule[] = [
  ...
  { id: 'diagnostics', no: '04', cn: '智能诊断', en: 'DIAGNOSTICS', summary: '标定、反演、观测融合、信号质量和异常识别。', input: '传感器原始信号、诊断几何与标定信息', output: '带质量标记和不确定度的观测与状态', aiRole: '去噪、缺失补全、异常识别和多模态状态估计。', trust: '盲测、漂移监测、残差保留和失效降级。', href: '/#domains', color: '#65e6d2', position: [225, 315], size: [164, 86], intensities: [3, 3, 4, 4, 4, 2] },
        ...
        <div className="fusionTwinMapViewport" aria-label="可横向滚动查看完整系统地图">
          <div className="fusionTwinMapCanvas">
            <div className={`fusionTwinMapFallback${ready ? ' isHidden' : ''}`} aria-hidden={ready || undefined}>
              ...
              <div className="fallbackCore"><span>实体装置</span><i>→</i><span>智能诊断</span><i>→</i><span>数据基座</span><i>→</i><span>总体集成</span><i>→</i><span>人机交互</span><i>→</i><span>集成控制</span><i>→</i><span>安全与授权门</span></div>
