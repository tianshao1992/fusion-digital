  ...
  return <main className="portalPage">
    ...
    <header className="portalHero" id="top">
      <div className="heroText">
        ...
        <div className="heroActions"><a className="solid" href="/digital-prototype">进入数字样机工作台</a><a href="#device-3d">轻量三维预览</a><a href="#domains">探索知识域</a><a href="/facilities">查看全球装置状态</a></div>
    ...
    <div className="prototypePortalCta"><div><p>CAD / CAE DIGITAL PROTOTYPE</p><h2>完整主体装置、装配树与工程数据入口，在一个独立工作台中协同。</h2></div><a href="/digital-prototype">打开数字样机工作台 <span>→</span></a></div>
